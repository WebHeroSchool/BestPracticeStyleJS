...
1. <aПравило 1: Объявление переменных.</a>
2. <aПравило 2: Одна переменная за раз.</a>
3. <aПравило 3: Точка с запятой — ОБЯЗАТЕЛНА.</a>
4. <aПравило 4: Отдавайте предпочтение стрелочным функциям.</a>
5. <aПравило 5: Именование функций.</a>
6. <aПравило 6: Создание объектов.</a>
7. <aПравило 7: Создание массивов.</a>
8. <aПравило 8: Пустое пространство.</a>
9. <aПравило 9: Используйте строки шаблона вместо конкатенации.</a>
10. <aПравило 10: Докуменитруйте код.</a>
